    ...
    <section id="content">
        <div id="entry-form">
            <form id="entry" method="post">
                    ...
                    <div class="center-vertical">
                        <span class="left-margin clickable-text" id="dropdown-choose-date" dropdown-name="datepicker">TODAY</span> <span
                            class="left-margin clickable-text" id="dropdown-choose-type" dropdown-name="choose-type"> I've been
                                learning </span> <span class="left-margin"> <input id="skill" type="text"
                ...
                <div class="entry-form-line">
                    <div class="center-vertical">
                        <span class="left-margin">It was</span><span class="left-margin clickable-text"
                                                                     id="dropdown-choose-level"
                                                                     dropdown-name="choose-level">easy</span> <span
                            class="left-margin">and it took me</span><span
                            class="left-margin"><input id="learningtime" type="number" placeholder="..."
                                                       style="height: 22px; width: 40px;"/></span> <span
        ...
        <div id="wall">
            <div class="entry-box">
                ...
                <div style="display: table; float: left;">
                    <div class="entry-text">
                        <a href="#">Krzysztof Jelski</a> has been learning <span
                            class="emphasized">HTML &amp; CSS</span> today.<br/>
                    ...
                    <div id="comment-1" class="comment-box comments" style="display: table; display: none;">
                        <div class="comment-input">
                            <form class="comment-textfield"><input type="text" id="comment-1-input"
                                                                   placeholder="Leave a comment..."/></form>
                        </div>
                    </div>
                </div>
            ...
            <div class="entry-box">
                ...
                <div style="display: table; float: left;">
                    <div class="entry-text">
                        <a href="#">Piotr Przybylak</a> has learnt <span class="emphasized">Kamasutra</span> today.<br/>
                        It
